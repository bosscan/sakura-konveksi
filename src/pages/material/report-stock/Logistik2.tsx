...
export default function Logistik2() {
  ...
  return (
    <Box sx={{ p:3 }}>
      <Typography variant="h6" fontWeight={700} sx={{ mb:2, textAlign:'center' }}>Report Stock - Logistik 2</Typography>
      <Paper sx={{ p:2, mb:2 }}>
      ...
      <TableExportToolbar title="Report Stock - Logistik 2" tableRef={tableRef} fileBaseName="logistik2-report" />
