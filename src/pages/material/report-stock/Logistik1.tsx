...
export default function Logistik1() {
  ...
  return (
    <Box sx={{ p:3 }}>
      <Typography variant="h6" fontWeight={700} sx={{ mb:2, textAlign:'center' }}>Report Stock - Logistik 1</Typography>
      <Paper sx={{ p:2, mb:2 }}>
  ...
  <TableExportToolbar title="Report Stock - Logistik 1" tableRef={tableRef} fileBaseName="logistik1-report" />
