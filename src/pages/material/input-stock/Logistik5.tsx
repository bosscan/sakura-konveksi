...
export default function Logistik5() {
  ...
  return (
    <Box sx={{ p:3 }}>
      <Typography variant="h6" fontWeight={700} sx={{ mb:2, textAlign:'center' }}>Input Stock - Logistik 5</Typography>
      <Paper sx={{ p:2, mb:2 }}>
      ...
      <TableExportToolbar title="Input Stock - Logistik 5" tableRef={tableRef} fileBaseName="logistik5-input" />
