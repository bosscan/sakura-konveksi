...
export default function Logistik4() {
  ...
  return (
    <Box sx={{ p:3 }}>
      <Typography variant="h6" fontWeight={700} sx={{ mb:2, textAlign:'center' }}>Input Stock - Logistik 4</Typography>
      <Paper sx={{ p:2, mb:2 }}>
      ...
      <TableExportToolbar title="Input Stock - Logistik 4" tableRef={tableRef} fileBaseName="logistik4-input" />
